...
import math
from utils.utils_image import bgr2ycbcr
...
def calculate_niqe(img, border, input_order='HWC', convert_to='y'):
    """Calculate NIQE (Natural Image Quality Evaluator) metric.
    ...
    # we use the official params estimated from the pristine dataset.
    niqe_pris_params = np.load('model_zoo/niqe_pris_params.npz')
