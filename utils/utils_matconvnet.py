...
#
#    torch.save(mat_net, 'R:/pytorch/KAIR_ongoing/model_zoo/ffdnet_gray_clip.pth')
#    
#    
#
#    crt_net = torch.load('R:/pytorch/KAIR_ongoing/model_zoo/imdn_x4.pth')
#    def show_kv(net):
...
#    network = net(in_nc=3, out_nc=3, nc=64, nb=23, gc=32, upscale=4, act_mode='K', upsample_mode='upconv')
#    
#    state_dict = network.state_dict()
#    for key, param in state_dict.items():
#        print(key)
#    from models.network_imdn import IMDN as net
#    network = net(in_nc=3, out_nc=3, nc=64, nb=8, upscale=4, act_mode='K', upsample_mode='pixelshuffle')
#    state_dict = network.state_dict()
#    mat_net = OrderedDict()
